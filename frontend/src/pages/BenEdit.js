...
const BenEdit = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/ben/" + empid).then((res) => {
            ...
            addresschange(resp.email);
            phonechange(resp.phone);
            requestchange(resp.request);
    ...
    const handlesubmit=(e)=>{
      e.preventDefault();
      const empdata={id,name,address,phone,request,active};
      

      fetch("http://localhost:3000/ben/"+empid,{
        method:"PUT",
            ...
            <div className="offset-lg-3 col-lg-6"component="main" maxWidth="100%" style={{ marginTop: '20px' }}>
                <form className="container" onSubmit={handlesubmit}>
                    ...
                    <div className="card-title"style={{ marginTop: '20px',textAlign: "center" }}>
                         <h2>Edit Benificiary Details</h2>
                </div>
                            ...
                            <div className="column">
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        ...
                                        <input value={request} onChange={e=>requestchange(e.target.value)} className="form-control"></input>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                       ...
                                       <Link to="/benlisting" className="btn btn-danger">Back</Link>
                                    </div>
                                </div>
